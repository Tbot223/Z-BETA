...
function response(room, msg, sender, isGroupChat, replier, imageDB, packageName) {
  ...
  if (msg == '$가입') {
    ...
    } else if (sender.includes('\n')||sender.includes('')||sender.includes('@')||sender.includes('\'')) {
